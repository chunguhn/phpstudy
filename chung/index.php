<?php
	...
	$arrLink['ch5'] = [
			['ln' => './ch_5-1.php', 'nm' => '챕터5-1', 'info' => '함수 기초']
	];

	$arrLink['ch6'] = [
			['ln' => './ch_6-1.php', 'nm' => '챕터6-1', 'info' => '클래스 기초']
	];

	$arrLink['ch8'] = [
			['ln' => './ch_8-1.php', 'nm' => '챕터8-1', 'info' => 'DB 기초'],
			['ln' => './ch_8-2.php', 'nm' => '챕터8-2', 'info' => 'DB 기초'],
			['ln' => './ch_8-3.php', 'nm' => '챕터8-3', 'info' => 'DB 기초']
	];

	$arrLink['ch9'] = [
			['ln' => './ch_9-1.php', 'nm' => '챕터9-1', 'info' => '파일 기초']
	];

	$arrLink['ch10'] = [
			['ln' => './ch_10-1.php', 'nm' => '챕터10-1', 'info' => '쿠키&세션 기초']
	];

	$arrLink['ch11'] = [
			['ln' => './ch_11-1.php', 'nm' => '챕터11-1', 'info' => '통신? 기초']
	];
